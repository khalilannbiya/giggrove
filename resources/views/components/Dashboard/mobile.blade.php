    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm {{in_array(Route::current()->getName(), ['member.services.index', 'member.services.create']) ? 'font-medium text-gray-800' : 'font-light' }} }} font-medium text-gray-800 transition-colors duration-150 hover:text-gray-800"
