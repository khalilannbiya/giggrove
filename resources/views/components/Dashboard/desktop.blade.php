    ...
    <div class="text-serv-bg">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm transition-colors duration-150 hover:text-gray-800 {{ Route::current()->getName() == 'member.dashboard.index' ? 'font-medium text-gray-800' : 'font-light' }}"
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm transition-colors duration-150 hover:text-gray-800 {{ in_array(Route::current()->getName(), ['member.services.index', 'member.services.create', 'member.services.edit']) ? 'font-medium text-gray-800' : 'font-light' }}"
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm transition-colors duration-150 hover:text-gray-800 {{ in_array(Route::current()->getName(), ['member.requests.index']) ? 'font-medium text-gray-800' : 'font-light' }}"
