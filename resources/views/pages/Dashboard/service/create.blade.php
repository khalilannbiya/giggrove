    ...
    <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
        <ol class="inline-flex p-0 list-none">
            <li class="flex items-center">
                <a href="{{ route('member.services.index') }}" class="text-gray-400">My Services</a>
            ...
            <li class="flex items-center">
                <a href="{{ route('member.services.create') }}" class="font-medium">Add Your Service</a>
            </li>
        </ol>
    </nav>
        ...
        <div class="grid gap-5 md:grid-cols-12">
            <main class="col-span-12 p-4 md:pt-0">
                <div class="px-2 py-2 mt-2 bg-white rounded-xl">
                    ...
                    <form action="{{ route('member.services.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Keunggulan 1" type="text" name="excellences[]"
                                            id="excellence" autocomplete="excellence"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">

                                        <input placeholder="Keunggulan 2" type="text" name="excellences[]"
                                            id="excellence" autocomplete="excellence"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">

                                        <input placeholder="Keunggulan 3" type="text" name="excellences[]"
                                            id="excellence" autocomplete="excellence"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Thumbnail 1" type="file" name="thumbnails[]" id="thumbnail"
                                        ...
                                        <input placeholder="Thumbnail 2" type="file" name="thumbnails[]" id="thumbnail"
                                            autocomplete="thumbnail"
                                            class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">

                                        <input placeholder="Thumbnail 3" type="file" name="thumbnails[]" id="thumbnail"
                                            autocomplete="thumbnail"
                                            class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Keunggulan 1" type="text" name="strengths[]" id="strength"
                                            autocomplete="strength"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">

                                        <input placeholder="Keunggulan 2" type="text" name="strengths[]" id="strength"
                                            autocomplete="strength"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">

                                        <input placeholder="Keunggulan 3" type="text" name="strengths[]" id="strength"
                                            autocomplete="strength"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
...
<script type="text/javascript">
    // add row
        $("#addAdvantagesRow").click(function() {
            var html = '';
            html += '<input placeholder="Keunggulan Lainnya" type="text" name="strengths[]" id="strength" autocomplete="strength" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
...
<script type="text/javascript">
    // add row
        $("#addServicesRow").click(function() {
            var html = '';
            html += '<input placeholder="Keunggulan Lainnya" type="text" name="excellences[]" id="excellence" autocomplete="excellence" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
...
<script type="text/javascript">
    // add row
        $("#addTaglineRow").click(function() {
            var html = '';
            html += '<input placeholder="Tagline" type="text" name="taglines[]" id="tagline" autocomplete="tagline" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
...
<script type="text/javascript">
    // add row
        $("#addThumbnailRow").click(function() {
            var html = '';
            html += '<input placeholder="Thumbnail Lainnya" type="file" name="thumbnails[]" id="thumbnail" autocomplete="thumbnail" class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
