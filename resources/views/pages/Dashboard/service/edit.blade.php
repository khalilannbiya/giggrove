                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Service apa yang ingin kamu tawarkan?" type="text"
                                            name="title" id="title" autocomplete="title" autofocus
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Keunggulan 1" type="file" name="thumbnails[]" id="thumbnail"
                                        ...
                                        <input placeholder="Keunggulan 2" type="file" name="thumbnails[]" id="thumbnail"
                                            autocomplete="thumbnail"
                                            class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">

                                        <input placeholder="Keunggulan 3" type="file" name="thumbnails[]" id="thumbnail"
                                            autocomplete="thumbnail"
                                            class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
