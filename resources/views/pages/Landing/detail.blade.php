                ...
                <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                    <div class="flex mt-2 flex-nowrap">
                        <img :class="{'border-4 border-serv-button': active === 1}"
                            @click="changeThumbnail('https://source.unsplash.com/_SgRNwAVNKw/1600x900/',1)" src={{
                            url("https://source.unsplash.com/_SgRNwAVNKw/250x160/") }} alt=""
                            class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                        <img :class="{'border-4 border-serv-button': active === 2}"
                            @click="changeThumbnail('https://source.unsplash.com/GXNo-OJynTQ/1600x900/',2)" src={{
                            url("https://source.unsplash.com/GXNo-OJynTQ/250x160/") }} alt=""
                            class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                        <img :class="{'border-4 border-serv-button': active === 3}"
                            @click="changeThumbnail('https://source.unsplash.com/x-HpilsdKEk/1600x900/',3)" src={{
                            url("https://source.unsplash.com/x-HpilsdKEk/250x160/") }} alt=""
                            class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                        <img :class="{'border-4 border-serv-button': active === 4}"
                            @click="changeThumbnail('https://source.unsplash.com/hLit2zL-Dhk/1600x900/',4)" src={{
                            url("https://source.unsplash.com/hLit2zL-Dhk/250x160/") }} alt=""
                            class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                        <img :class="{'border-4 border-serv-button': active === 5}"
                            @click="changeThumbnail('https://source.unsplash.com/i1VQZsU86ok/1600x900/',5)" src={{
                            url("https://source.unsplash.com/i1VQZsU86ok/250x160/") }} alt=""
                            class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                        <img :class="{'border-4 border-serv-button': active === 6}"
                            @click="changeThumbnail('https://source.unsplash.com/iEiUITs149M/1600x900/',6)" src={{
                            url("https://source.unsplash.com/iEiUITs149M/250x160/") }} alt=""
                            class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                    </div>
                </div>
            </div>
                        ...
                        <div class="grid md:grid-cols-12">
                            <div class="flex items-center col-span-12 p-2 lg:col-span-6">
                                <div class="flex items-center space-x-4">
                                    <img src={{
                                        url("https://avatars2.githubusercontent.com/u/1490347?s=460&u=39d7a6b9bc030244e2c509119e5f64eabb2b1727&v=4")
        ...
        <aside class="p-4 lg:col-span-4 md:col-span-12 md:pt-0">
            <div class="mb-4 border rounded-lg border-serv-testimonial-border">
                ...
                <div class="flex items-start px-4 pt-6">
                    <img class="object-cover w-16 h-16 mr-4 rounded-full" src={{
